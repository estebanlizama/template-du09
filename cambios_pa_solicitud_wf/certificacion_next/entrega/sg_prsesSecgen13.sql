...
/* Procedimiento : Analisis2.sg_prsesSecgen13
   ...
   Actualizacion: 2026/09/15 (agrega f_asignacion y dias_espera)
*/
...
BEGIN
    ...
    SELECT apso.nro_aproba, apso.id_funprse, apso.rut_usua, apso.rut_autori,
        ...
        apso.f_creacion f_asignacion,
        datediff(dd, isnull(apso.f_creacion, soli.f_solicit), getdate()) dias_espera,
