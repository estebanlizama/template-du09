...
BEGIN
    ...
    SET
        ...
        per_desde = @per_desde,
        per_hasta = @per_hasta,
        rut_jefpro = @rut_jefpro,
        cod_unifin = @cod_unifin,
        cod_ccto = @cod_ccto,
        cc_global = @cc_global,
        pry_global = @pry_global,
    ...
    BEGIN
        SELECT 'Error al actualizar información de validación de proceso. Se aborta el procedimiento' msg
        IF @@transtate = 2
            ROLLBACK TRAN
        RETURN
    END
...
GRANT EXECUTE ON Analisis2.sg_prseuSecgen01 TO UsuaVrac
GO
