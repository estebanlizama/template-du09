...
BEGIN
    ...
    LEFT JOIN fin21_db..es_tfin tfin
        ON tfin.cod_tfinan = c.cod_tfinan
    LEFT JOIN fin21_db..es_ufin ufin
        ON ufin.cod_unifin = p.cod_unifin
    LEFT JOIN fin21_db..sf_ftfn ftfn
        ON ftfn.cod_ftfn = c.cod_ftfn
    LEFT JOIN fin21_db..sf_deaf deaf
        ON deaf.decr_afect = c.decr_afect
